...
export const startDevServer = async (
  ...
  if (!portAlreadyInUse) {
    ...
    console.log(chalk.greenBright(`    UsePrint ${packageJson.version}`));
  ...
  const spinner = ora({
    text: 'Getting useprint preview server ready...\n',
    prefixText: ' ',
  }).start();
  ...
  process.env = {
    ...
    ...getEnvVariablesForPreviewApp(
      // If we don't do normalization here, stuff like https://github.com/maxscn/useprint/issues/1354 happens.
